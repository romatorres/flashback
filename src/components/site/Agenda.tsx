...
export default function Agenda() {
  ...
  const hasMore = agendas && agendas.length > visibleCount;
              ...
              {hasMore && (
                <div className="mt-12 text-center">
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-2 bg-secondary/50 hover:bg-secondary text-secondary-foreground font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 border border-border group"
                  >
                    Veja mais
